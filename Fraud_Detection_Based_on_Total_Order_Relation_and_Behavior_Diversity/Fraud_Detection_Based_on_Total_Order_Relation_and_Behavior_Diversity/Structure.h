...
struct Transaction {
    ...
    Transaction() : 
        ...
        payment_status(false), seller_message(""), 
        card_id(""), 
        user_id(""), 
        frequency(0) {}
    ...
    Transaction(const Transaction& t) :
        ...
        seller_message(t.seller_message),
        card_id(t.card_id),
        user_id(t.user_id),
    ...
    bool operator==(const Transaction& t) const {
        return (time == t.time) && (amount == t.amount) && (payment_status == t.payment_status) && (seller_message == t.seller_message) && (card_id == t.card_iod) && (user_id == t.user_id);
    }
